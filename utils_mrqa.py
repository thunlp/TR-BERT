        ...
        for qa in paragraph["qas"]:
            ...
            if is_training:
                ...
                if not is_impossible:
                    flag = True
                    for answer in qa["detected_answers"][0:1]: # to match deformer setting, remain the first answer
                        orig_answer_text = paragraph_text[ answer["char_spans"][0][0]: answer["char_spans"][0][1]+1]#answer["text"]
                        answer_offset = answer["char_spans"][0][0]
                        # answer_length = len(orig_answer_text)
                        start_position = char_to_word_offset[answer_offset]
                        end_position = char_to_word_offset[answer["char_spans"][0][1]]
        ...
        for (doc_span_index, doc_span) in enumerate(doc_spans):
            ...
            features.append(
                InputFeatures(
                    ...
                    start_position=start_positions[0],  # to match deformer setting
