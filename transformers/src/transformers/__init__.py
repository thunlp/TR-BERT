...
if is_torch_available():
    ...
    from .modeling_bert import (
        ...
        BertForSequenceClassificationSigmoid,
        ...
        BertForMultipleChoiceSigmoid,
        BertForMultipleChoiceSoftmax
    )
    from .modeling_initbert import (
        InitBertForinit,
        InitBertForRace,
        InitBertForNormalRace,
    )

    from .modeling_initdistilbert import (
        InitDistilBertForinit,
    )

    from .modeling_autoqabert import (
        AUTOQABertModel,
    ...
    from .modeling_autobert import (
        AUTOBertForMultipleChoice,
        AUTOBertForSequenceClassification,
    )

    from .modeling_automcbert import (
    ...
    from .modeling_distilautobert import (
        AUTODistilBertForSequenceClassification
    )
    from .modeling_distilautoqabert import (
        AUTOQADistilBertForQuestionAnswering
    )
    from .modeling_distilautomcbert import (
