...
class Transformer(nn.Module):
    ...
    def forward(self, x, attn_mask=None, head_mask=None, rank_prob=None):
        all_hidden_states = ()
        all_attentions = ()
        hidden_states = x
...
class InitDistilBertModel(DistilBertPreTrainedModel):
    ...
    def forward(self, input_ids=None, attention_mask=None, head_mask=None, inputs_embeds=None, rank_prob=None):
        ...
        tfmr_output = self.transformer(x=inputs_embeds, attn_mask=attention_mask, head_mask=head_mask,  rank_prob=rank_prob)
